...
class Our_works extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->viewData->our_works = $this->general_model->get_all("our_works", null, null, ["isActive" => 1, "lang" => $this->viewData->lang], ["title" =>  $search, "content" =>  $search, "createdAt" =>  $search, "updatedAt" =>  $search], [], []);
