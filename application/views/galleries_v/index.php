                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp animated mb-4" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInUp;">
                        <div class="services-one__single h-100">
                            <div class="services-one__single-inner">
                                ...
                                <h3 class="services-one__title"><a href="<?= base_url(lang("routes_galleries") . "/" . lang("routes_gallery") . "/" . $v->url) ?>" rel="dofollow" title="<?= lang("viewService") ?>"><?= $v->title ?></a></h3>
                                <div class="services-one__btn-box">
                                    <a class="services-one__btn" href="<?= base_url(lang("routes_galleries") . "/" . lang("routes_gallery") . "/" . $v->url) ?>" rel="dofollow" title="<?= lang("viewService") ?>"><?= lang("viewService") ?> <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
