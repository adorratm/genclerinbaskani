...
<div class="container-fluid mt-xl-50 mt-lg-30 mt-15 bg-white p-3">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <form data-table="detailTable" action="<?= base_url("form_inputs/file_upload/$item->id/$item->lang"); ?>" id="dropzone<?= $item->lang ?>" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?= base_url("services/file_upload/$item->id/$item->lang"); ?>'}">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <form id="filter_form" onsubmit="return false">
                <div class="d-flex flex-wrap">
                    ...
                    <label for="search_button" class="mx-1">
                        <button class="btn btn-sm btn-outline-success rounded-0 " onclick="reloadTable('detailTable')" id="search_button" data-toggle="tooltip" data-placement="top" data-title="Form Görseli Ara"><i class="fa fa-search"></i></button>
                </div>
            </form>
            ...
            <script>
                ...
                $(document).ready(function() {
                    TableInitializerV2("detailTable", obj, {}, "<?= base_url("form_inputs/detailDatatable/{$item->id}") ?>", "<?= base_url("form_inputs/fileRankSetter/{$item->id}") ?>", true);
                });
            </script>
        </div><!-- END column -->
    </div>
